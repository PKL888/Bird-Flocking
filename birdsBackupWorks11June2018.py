    ...
    if x + w > mouse[0] > x and y + h > mouse[1] > y:
        ...
        if click[0] == 1 and numBirds is not None:
            ...
            if action == "add":
                ...
                print "bluebird2"
                print mybirdrect, "bluebird2"

                return mybird, mybirdrect

            elif action == "rainbow":
                mybird = pygame.image.load("butterfly.gif")

                mybird = pygame.transform.scale(mybird, (7, 7))
                mybirdrect = mybird.get_rect()

                print "rainbow"
                print mybirdrect, "rainbow"
...
while 1:
    ...
    # The blue birds 2 birds button -->
    button("B!", 250, 25, 25, 25, blue, light_blue, numBirds, "bluebird2")

    # The rainbow butterfly birds button -->
    button("R!", 300, 25, 25, 25, blue, light_blue, numBirds, "rainbow")
